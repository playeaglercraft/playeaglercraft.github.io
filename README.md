...
To make a server for EaglercraftX 1.8 the recommended software to use is EaglerXServer ("EaglerXServer"), which you can get from lax1dude here: [https://github.com/MutantBloodcell/eaglerxserver/](https://github.com/MutantBloodcell/eaglerxserver/)
...
The default eaglercraftXOpts values is this:
    ...
    window.eaglercraftXOpts = {
        ...
        relays: [
            ...
            { addr: "wss://relay.shhnowisnottheti.me/", comment: "eagler relay #1", primary: relayId == 2 }
        ]
    };
